// AUTO-GENERATED by scripts/generate-lucide-icons.mjs — do not edit by hand.
// 1711 icons + 249 aliases from lucide-react v1.16.0.
...
// Aliases (deprecated lucide names mapped to current ones, e.g. "home" -> "house").
Object.assign(lucideIconSvgs, {
  "activity-square": lucideIconSvgs["square-activity"],
  "alarm-check": lucideIconSvgs["alarm-clock-check"],
  "alarm-minus": lucideIconSvgs["alarm-clock-minus"],
  "alarm-plus": lucideIconSvgs["alarm-clock-plus"],
  "alert-circle": lucideIconSvgs["circle-alert"],
  "alert-octagon": lucideIconSvgs["octagon-alert"],
  "alert-triangle": lucideIconSvgs["triangle-alert"],
  "align-center": lucideIconSvgs["text-align-center"],
  "align-justify": lucideIconSvgs["text-align-justify"],
  "align-left": lucideIconSvgs["text-align-start"],
  "align-right": lucideIconSvgs["text-align-end"],
  "area-chart": lucideIconSvgs["chart-area"],
  "arrow-down-01": lucideIconSvgs["arrow-down-0-1"],
  "arrow-down-10": lucideIconSvgs["arrow-down-1-0"],
  "arrow-down-az": lucideIconSvgs["arrow-down-a-z"],
  "arrow-down-circle": lucideIconSvgs["circle-arrow-down"],
  "arrow-down-left-from-circle": lucideIconSvgs["circle-arrow-out-down-left"],
  "arrow-down-left-from-square": lucideIconSvgs["square-arrow-out-down-left"],
  "arrow-down-left-square": lucideIconSvgs["square-arrow-down-left"],
  "arrow-down-right-from-circle": lucideIconSvgs["circle-arrow-out-down-right"],
  "arrow-down-right-from-square": lucideIconSvgs["square-arrow-out-down-right"],
  "arrow-down-right-square": lucideIconSvgs["square-arrow-down-right"],
  "arrow-down-square": lucideIconSvgs["square-arrow-down"],
  "arrow-down-za": lucideIconSvgs["arrow-down-z-a"],
  "arrow-left-circle": lucideIconSvgs["circle-arrow-left"],
  "arrow-left-square": lucideIconSvgs["square-arrow-left"],
  "arrow-right-circle": lucideIconSvgs["circle-arrow-right"],
  "arrow-right-square": lucideIconSvgs["square-arrow-right"],
  "arrow-up-01": lucideIconSvgs["arrow-up-0-1"],
  "arrow-up-10": lucideIconSvgs["arrow-up-1-0"],
  "arrow-up-az": lucideIconSvgs["arrow-up-a-z"],
  "arrow-up-circle": lucideIconSvgs["circle-arrow-up"],
  "arrow-up-left-from-circle": lucideIconSvgs["circle-arrow-out-up-left"],
  "arrow-up-left-from-square": lucideIconSvgs["square-arrow-out-up-left"],
  "arrow-up-left-square": lucideIconSvgs["square-arrow-up-left"],
  "arrow-up-right-from-circle": lucideIconSvgs["circle-arrow-out-up-right"],
  "arrow-up-right-from-square": lucideIconSvgs["square-arrow-out-up-right"],
  "arrow-up-right-square": lucideIconSvgs["square-arrow-up-right"],
  "arrow-up-square": lucideIconSvgs["square-arrow-up"],
  "arrow-up-za": lucideIconSvgs["arrow-up-z-a"],
  "asterisk-square": lucideIconSvgs["square-asterisk"],
  "axis-3-d": lucideIconSvgs["axis-3d"],
  "badge-help": lucideIconSvgs["badge-question-mark"],
  "bar-chart-2": lucideIconSvgs["chart-no-axes-column"],
  "bar-chart-3": lucideIconSvgs["chart-column"],
  "bar-chart-4": lucideIconSvgs["chart-column-increasing"],
  "bar-chart-big": lucideIconSvgs["chart-column-big"],
  "bar-chart-horizontal-big": lucideIconSvgs["chart-bar-big"],
  "bar-chart-horizontal": lucideIconSvgs["chart-bar"],
  "bar-chart": lucideIconSvgs["chart-no-axes-column-increasing"],
  "between-horizonal-end": lucideIconSvgs["between-horizontal-end"],
  "between-horizonal-start": lucideIconSvgs["between-horizontal-start"],
  "book-template": lucideIconSvgs["book-dashed"],
  "box-select": lucideIconSvgs["square-dashed"],
  "candlestick-chart": lucideIconSvgs["chart-candlestick"],
  "check-circle-2": lucideIconSvgs["circle-check"],
  "check-circle": lucideIconSvgs["circle-check-big"],
  "check-square-2": lucideIconSvgs["square-check"],
  "check-square": lucideIconSvgs["square-check-big"],
  "chevron-down-circle": lucideIconSvgs["circle-chevron-down"],
  "chevron-down-square": lucideIconSvgs["square-chevron-down"],
  "chevron-left-circle": lucideIconSvgs["circle-chevron-left"],
  "chevron-left-square": lucideIconSvgs["square-chevron-left"],
  "chevron-right-circle": lucideIconSvgs["circle-chevron-right"],
  "chevron-right-square": lucideIconSvgs["square-chevron-right"],
  "chevron-up-circle": lucideIconSvgs["circle-chevron-up"],
  "chevron-up-square": lucideIconSvgs["square-chevron-up"],
  "circle-help": lucideIconSvgs["circle-question-mark"],
  "circle-slashed": lucideIconSvgs["circle-slash-2"],
  "clipboard-edit": lucideIconSvgs["clipboard-pen"],
  "clipboard-signature": lucideIconSvgs["clipboard-pen-line"],
  "code-2": lucideIconSvgs["code-xml"],
  "code-square": lucideIconSvgs["square-code"],
  "columns-settings": lucideIconSvgs["columns-3-cog"],
  "columns": lucideIconSvgs["columns-2"],
  "contact-2": lucideIconSvgs["contact-round"],
  "curly-braces": lucideIconSvgs["braces"],
  "divide-circle": lucideIconSvgs["circle-divide"],
  "divide-square": lucideIconSvgs["square-divide"],
  "dot-square": lucideIconSvgs["square-dot"],
  "download-cloud": lucideIconSvgs["cloud-download"],
  "edit-2": lucideIconSvgs["pen"],
  "edit-3": lucideIconSvgs["pen-line"],
  "edit": lucideIconSvgs["square-pen"],
  "equal-square": lucideIconSvgs["square-equal"],
  "file-audio-2": lucideIconSvgs["file-headphone"],
  "file-audio": lucideIconSvgs["file-headphone"],
  "file-axis-3-d": lucideIconSvgs["file-axis-3d"],
  "file-badge-2": lucideIconSvgs["file-badge"],
  "file-bar-chart-2": lucideIconSvgs["file-chart-column"],
  "file-bar-chart": lucideIconSvgs["file-chart-column-increasing"],
  "file-check-2": lucideIconSvgs["file-check-corner"],
  "file-code-2": lucideIconSvgs["file-code-corner"],
  "file-cog-2": lucideIconSvgs["file-cog"],
  "file-edit": lucideIconSvgs["file-pen"],
  "file-json-2": lucideIconSvgs["file-braces-corner"],
  "file-json": lucideIconSvgs["file-braces"],
  "file-key-2": lucideIconSvgs["file-key"],
  "file-line-chart": lucideIconSvgs["file-chart-line"],
  "file-lock-2": lucideIconSvgs["file-lock"],
  "file-minus-2": lucideIconSvgs["file-minus-corner"],
  "file-pie-chart": lucideIconSvgs["file-chart-pie"],
  "file-plus-2": lucideIconSvgs["file-plus-corner"],
  "file-question": lucideIconSvgs["file-question-mark"],
  "file-search-2": lucideIconSvgs["file-search-corner"],
  "file-signature": lucideIconSvgs["file-pen-line"],
  "file-type-2": lucideIconSvgs["file-type-corner"],
  "file-video-2": lucideIconSvgs["file-video-camera"],
  "file-video": lucideIconSvgs["file-play"],
  "file-volume-2": lucideIconSvgs["file-signal"],
  "file-warning": lucideIconSvgs["file-exclamation-point"],
  "file-x-2": lucideIconSvgs["file-x-corner"],
  "filter-x": lucideIconSvgs["funnel-x"],
  "filter": lucideIconSvgs["funnel"],
  "flip-horizontal": lucideIconSvgs["square-centerline-dashed-horizontal"],
  "flip-vertical": lucideIconSvgs["square-centerline-dashed-vertical"],
  "folder-cog-2": lucideIconSvgs["folder-cog"],
  "folder-edit": lucideIconSvgs["folder-pen"],
  "fork-knife-crossed": lucideIconSvgs["utensils-crossed"],
  "fork-knife": lucideIconSvgs["utensils"],
  "form-input": lucideIconSvgs["rectangle-ellipsis"],
  "function-square": lucideIconSvgs["square-function"],
  "gantt-chart-square": lucideIconSvgs["square-chart-gantt"],
  "gantt-chart": lucideIconSvgs["chart-no-axes-gantt"],
  "gauge-circle": lucideIconSvgs["circle-gauge"],
  "git-commit": lucideIconSvgs["git-commit-horizontal"],
  "globe-2": lucideIconSvgs["earth"],
  "grab": lucideIconSvgs["hand-grab"],
  "grid-2-x-2-check": lucideIconSvgs["grid-2x2-check"],
  "grid-2-x-2-plus": lucideIconSvgs["grid-2x2-plus"],
  "grid-2-x-2-x": lucideIconSvgs["grid-2x2-x"],
  "grid-2-x-2": lucideIconSvgs["grid-2x2"],
  "grid-3-x-3": lucideIconSvgs["grid-3x3"],
  "grid": lucideIconSvgs["grid-3x3"],
  "help-circle": lucideIconSvgs["circle-question-mark"],
  "helping-hand": lucideIconSvgs["hand-helping"],
  "home": lucideIconSvgs["house"],
  "ice-cream-2": lucideIconSvgs["ice-cream-bowl"],
  "ice-cream": lucideIconSvgs["ice-cream-cone"],
  "indent-decrease": lucideIconSvgs["list-indent-decrease"],
  "indent-increase": lucideIconSvgs["list-indent-increase"],
  "indent": lucideIconSvgs["list-indent-increase"],
  "index": lucideIconSvgs["a-arrow-down"],
  "inspect": lucideIconSvgs["square-mouse-pointer"],
  "kanban-square-dashed": lucideIconSvgs["square-dashed-kanban"],
  "kanban-square": lucideIconSvgs["square-kanban"],
  "laptop-2": lucideIconSvgs["laptop-minimal"],
  "layers-3": lucideIconSvgs["layers"],
  "layout": lucideIconSvgs["panels-top-left"],
  "letter-text": lucideIconSvgs["text-initial"],
  "library-square": lucideIconSvgs["square-library"],
  "line-chart": lucideIconSvgs["chart-line"],
  "loader-2": lucideIconSvgs["loader-circle"],
  "location-edit": lucideIconSvgs["map-pin-pen"],
  "m-square": lucideIconSvgs["square-m"],
  "mail-question": lucideIconSvgs["mail-question-mark"],
  "menu-square": lucideIconSvgs["square-menu"],
  "message-circle-question": lucideIconSvgs["message-circle-question-mark"],
  "mic-2": lucideIconSvgs["mic-vocal"],
  "minus-circle": lucideIconSvgs["circle-minus"],
  "minus-square": lucideIconSvgs["square-minus"],
  "more-horizontal": lucideIconSvgs["ellipsis"],
  "more-vertical": lucideIconSvgs["ellipsis-vertical"],
  "mouse-pointer-square-dashed": lucideIconSvgs["square-dashed-mouse-pointer"],
  "move-3-d": lucideIconSvgs["move-3d"],
  "outdent": lucideIconSvgs["list-indent-decrease"],
  "paintbrush-2": lucideIconSvgs["paintbrush-vertical"],
  "palmtree": lucideIconSvgs["tree-palm"],
  "panel-bottom-inactive": lucideIconSvgs["panel-bottom-dashed"],
  "panel-left-inactive": lucideIconSvgs["panel-left-dashed"],
  "panel-right-inactive": lucideIconSvgs["panel-right-dashed"],
  "panel-top-inactive": lucideIconSvgs["panel-top-dashed"],
  "panels-left-right": lucideIconSvgs["columns-3"],
  "panels-top-bottom": lucideIconSvgs["rows-3"],
  "parking-circle-off": lucideIconSvgs["circle-parking-off"],
  "parking-circle": lucideIconSvgs["circle-parking"],
  "parking-square-off": lucideIconSvgs["square-parking-off"],
  "parking-square": lucideIconSvgs["square-parking"],
  "pause-circle": lucideIconSvgs["circle-pause"],
  "pause-octagon": lucideIconSvgs["octagon-pause"],
  "pen-box": lucideIconSvgs["square-pen"],
  "pen-square": lucideIconSvgs["square-pen"],
  "percent-circle": lucideIconSvgs["circle-percent"],
  "percent-diamond": lucideIconSvgs["diamond-percent"],
  "percent-square": lucideIconSvgs["square-percent"],
  "pi-square": lucideIconSvgs["square-pi"],
  "pie-chart": lucideIconSvgs["chart-pie"],
  "pilcrow-square": lucideIconSvgs["square-pilcrow"],
  "play-circle": lucideIconSvgs["circle-play"],
  "play-square": lucideIconSvgs["square-play"],
  "plug-zap-2": lucideIconSvgs["plug-zap"],
  "plus-circle": lucideIconSvgs["circle-plus"],
  "plus-square": lucideIconSvgs["square-plus"],
  "power-circle": lucideIconSvgs["circle-power"],
  "power-square": lucideIconSvgs["square-power"],
  "rotate-3-d": lucideIconSvgs["rotate-3d"],
  "rows": lucideIconSvgs["rows-2"],
  "scale-3-d": lucideIconSvgs["scale-3d"],
  "scatter-chart": lucideIconSvgs["chart-scatter"],
  "school-2": lucideIconSvgs["university"],
  "scissors-square-dashed-bottom": lucideIconSvgs["square-bottom-dashed-scissors"],
  "scissors-square": lucideIconSvgs["square-scissors"],
  "send-horizonal": lucideIconSvgs["send-horizontal"],
  "shield-close": lucideIconSvgs["shield-x"],
  "shield-question": lucideIconSvgs["shield-question-mark"],
  "sidebar-close": lucideIconSvgs["panel-left-close"],
  "sidebar-open": lucideIconSvgs["panel-left-open"],
  "sidebar": lucideIconSvgs["panel-left"],
  "sigma-square": lucideIconSvgs["square-sigma"],
  "slash-square": lucideIconSvgs["square-slash"],
  "sliders": lucideIconSvgs["sliders-vertical"],
  "sort-asc": lucideIconSvgs["arrow-up-narrow-wide"],
  "sort-desc": lucideIconSvgs["arrow-down-wide-narrow"],
  "split-square-horizontal": lucideIconSvgs["square-split-horizontal"],
  "split-square-vertical": lucideIconSvgs["square-split-vertical"],
  "square-gantt-chart": lucideIconSvgs["square-chart-gantt"],
  "stars": lucideIconSvgs["sparkles"],
  "stop-circle": lucideIconSvgs["circle-stop"],
  "subtitles": lucideIconSvgs["captions"],
  "table-config": lucideIconSvgs["columns-3-cog"],
  "terminal-square": lucideIconSvgs["square-terminal"],
  "test-tube-2": lucideIconSvgs["test-tube-diagonal"],
  "text-select": lucideIconSvgs["square-dashed-text"],
  "text-selection": lucideIconSvgs["square-dashed-text"],
  "text": lucideIconSvgs["text-align-start"],
  "train": lucideIconSvgs["tram-front"],
  "tv-2": lucideIconSvgs["tv-minimal"],
  "unlock-keyhole": lucideIconSvgs["lock-keyhole-open"],
  "unlock": lucideIconSvgs["lock-open"],
  "upload-cloud": lucideIconSvgs["cloud-upload"],
  "user-2": lucideIconSvgs["user-round"],
  "user-check-2": lucideIconSvgs["user-round-check"],
  "user-circle-2": lucideIconSvgs["circle-user-round"],
  "user-circle": lucideIconSvgs["circle-user"],
  "user-cog-2": lucideIconSvgs["user-round-cog"],
  "user-minus-2": lucideIconSvgs["user-round-minus"],
  "user-plus-2": lucideIconSvgs["user-round-plus"],
  "user-square-2": lucideIconSvgs["square-user-round"],
  "user-square": lucideIconSvgs["square-user"],
  "user-x-2": lucideIconSvgs["user-round-x"],
  "users-2": lucideIconSvgs["users-round"],
  "verified": lucideIconSvgs["badge-check"],
  "wallet-2": lucideIconSvgs["wallet-minimal"],
  "wand-2": lucideIconSvgs["wand-sparkles"],
  "waves": lucideIconSvgs["waves-horizontal"],
  "wrap-text": lucideIconSvgs["text-wrap"],
  "x-circle": lucideIconSvgs["circle-x"],
  "x-octagon": lucideIconSvgs["octagon-x"],
  "x-square": lucideIconSvgs["square-x"]
});

export const lucideIconNames: string[] = Object.keys(lucideIconSvgs);
